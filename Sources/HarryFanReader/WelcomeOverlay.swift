...
extension OverlayFactory {
    ...
    static func makeWelcomeOverlay(rows: Int = AppSettings.rows - 2, cols: Int = AppSettings.cols, fgColor: Color = Colors.theme.foreground) -> ScreenLayer {
    ...
    static func welcomeActionBarItems(cols: Int = AppSettings.cols) -> [String] {
        [
...
func welcomeActionBarItems(cols: Int = AppSettings.cols) -> [String] {
