    ...
    override class func spec() {
        ...
        describe("FontManager") {
            context("initial state") {
                ...
                // Checks that the initial font is a valid MSDOSFont case.
            ...
            context("getting character bitmaps") {
                // Checks that basic ASCII characters return non-nil bitmaps of correct size.
                it("returns non-nil bitmaps for basic ASCII characters") {
                    ...
                    expect(spaceBitmap?.count).to(equal(128)) // 8x16 = 128 bits
                ...
                // Checks that special characters return non-nil bitmaps of correct size.
                ...
                // Checks that a Unicode character not in CP866 returns a fallback bitmap.
                ...
                // Checks that an empty character returns a fallback bitmap.
                ...
                // Checks that the same character always returns the same bitmap.
                ...
                // Checks that different characters return different bitmaps.
